function renderNav() {
	return `
        ...
        <ul>
            ...
            <li class="menu-item"><a href="#" onclick="renderPictures();getPictures()"><i class="fas fa-camera-retro"></i>Pictures</a></li>
            <li class="menu-item"><a href="#" onclick="renderReviews()"><i class="far fa-comment"></i>Reviews</a></li>       
